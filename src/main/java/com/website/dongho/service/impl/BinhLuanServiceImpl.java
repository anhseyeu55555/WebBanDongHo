...
public class BinhLuanServiceImpl implements BinhLuanService {
    private final BinhLuanRepository blRepository;
    ...
    public ResponseEntity<BinhLuan> updateBinhLuan(String mabl, BinhLuanDto binhluanDto) {
        try {
            ...
            findBL.setNoidung(binhluanDto.getNoidung());
            blRepository.save(findBL);
            return new ResponseEntity<BinhLuan>(findBL, HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<BinhLuan>(new BinhLuan(), HttpStatus.BAD_REQUEST);
        }
    }
